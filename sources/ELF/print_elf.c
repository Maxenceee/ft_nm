...
/*   Updated: 2025/06/30 18:59:30 by mgama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void
print_elf_program_flag(uint32_t flag)
{
	int res = 0;
	if (flag & 0x01)
		res += printf("X");
...
static void
print_elf_sym(t_elf_section *sym_section, t_elf_section *symstr_section, const char *ssymname)
{
...
void
print_elf_file(t_elf_file *elf_file, int level)
{
